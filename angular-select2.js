angular.module("rt.select2", [])
    ...
    .directive("select2", ["$rootScope", "$timeout", "$parse", "$filter", "select2Config", "select2Stack", function ($rootScope, $timeout, $parse, $filter, select2Config, select2Stack) {
        ...
        return {
            ...
            link: function (scope, element, attrs, controller) {
                ...
                if (attrs.watchOver) {
                	scope.$watchCollection('watchOver', function () {
						element.select2(opts);
					});
				}
	...
	.directive("dropdown", ["$rootScope", "$timeout", "$parse", "$filter", "select2Config", "select2Stack", function ($rootScope, $timeout, $parse, $filter, select2Config, select2Stack) {
    	"use strict";
